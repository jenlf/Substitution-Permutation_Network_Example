...
function encrypt() {
    ...
    for (let j = 0; j < plaintext.length; j++) {
        ...
        console.log(`XOR: ${result}, Substitute: ${substituteResult}, Permutate: ${permutatedResult}, Permuted in Decimal: ${decimalResult}`);
    } 
    console.log(cipherDecimal);     
    console.log(cipher);
...
function decrypt() {
    ...
    for (let n = 0; n < inputText.length; n++) {
        ...
        console.log(`Incoming Binary: ${binary8Bit}, ReversePermutate: ${reversePermutateVal}, ReverseSubstitute: ${reversedSubstituteVal}, XOR: ${decryptResult}`);
    }
...
function reverseSubstitute(binaryString) {
    ...
    //console.log("substr " + leftBits + " " + rightBits);
    //convert them to decimal
    let decimalToSubLeftBits = parseInt(leftBits, 2);
    let decimalToSubRightBits = parseInt(rightBits, 2);
    //console.log("dec to sub " + decimalToSubLeftBits + " " + decimalToSubRightBits);
    ...
    //console.log("reversSub" + reversedSubLeftBits + " " + reversedSubRightBits);
    //convert it back to char & return
    let reversedBits = reversedSubLeftBits + reversedSubRightBits;
    //console.log("rev" + reversedBits);
